...
driver.find_element_by_xpath("//*[@id='editarPerfil']").click()
time.sleep(3)

driver.find_element_by_xpath("//*[@id='editarDatos']").click()
time.sleep(3)

newcont = driver.find_element_by_id("_password")
newcont.send_keys("osaiopgato300")
time.sleep(3)

newcont = driver.find_element_by_id("_repeat_password")
newcont.send_keys("osaiopgato300")
time.sleep(3)


driver.find_element_by_xpath("//*[@id='savePersonalData']").click()
